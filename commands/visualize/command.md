---
description: "Generate a Mermaid flow diagram of a project's architecture. Reads the codebase, identifies the main flow, and outputs a self-contained HTML file."
---
