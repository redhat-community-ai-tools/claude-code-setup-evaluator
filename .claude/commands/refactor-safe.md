---
description: "Refactor internals without changing public API. Fixes structural problems (long functions, duplication, poor naming) while keeping the external interface identical."
---
